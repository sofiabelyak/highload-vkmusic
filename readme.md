...
- **Search Service**: 1,160 RPS / 100 RPS на сервер = 12 серверов × 2 × 1.5 = **36 серверов**
- **Playlist Service**: 232 RPS / 100 RPS на сервер = 3 сервера × 2 × 1.5 = **9 серверов**
- **Track Service**: 128 Gbit/s / 10 Gbit/s на сервер = 13 серверов × 2 × 1.5 = **39 серверов**
...
- **HAProxy**: 128 Gbit/s / 10 Gbit/s на сервер = 13 серверов × 2 × 1.5 = **39 серверов**
...
- **Search Service**: 1,160 RPS / 100 (сложная логика) = 116 CPU
- **Playlist Service**: 232 RPS / 100 (сложная логика) = 23.2 CPU
...
- **Recommendation Service**: 300 RPS / 100 (сложная логика) = 30 CPU
- **Analytics Service**: 1,388 RPS / 100 (сложная логика) = 138.8 CPU
...
|--------------|------------|----------------|----------|--------------|
| API серверы | 153 | 153 | 1,224 | 15.3 |
| Стриминговые серверы | 39 | 39 | 280.8 | 39 |
| PostgreSQL | 8 | 32 | 4,096 | 192 |
| Cassandra | 16 | 224 | 6,144 | 768 |
| ClickHouse | 12 | 168 | 3,072 | 384 |
| Redis | 16 | 224 | 6,144 | 768 |
| HAProxy | 39 | 39 | 312 | 3.9 |
| Nginx | 6 | 48 | 12 | 0.6 |
| Prometheus + Grafana | 4 | 288 | 512 | 64 |
| ELK Stack | 8 | 576 | 2,048 | 256 |
| **Итого** | 301 | 1,791 | 23,844.8 | 2,490.8 |

**Расчеты:**
- **API серверы**: (33 + 24 + 36 + 9 + 9 + 42) = 153 серверов × 1 CPU = 153 физических CPU
- **Стриминговые серверы**: 39 серверов × 1 CPU = 39 физических CPU
...
- **HAProxy**: 39 серверов × 1 CPU = 39 физических CPU
